...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void addPet(Pet pet) {
        ...
        value.put(FIELD_NAME, pet.getName());
        value.put(FIELD_DETAIL, pet.getDetails());
        value.put(FIELD_PHONE_NUMBER, pet.getPhone());
        value.put(FIELD_IMAGE_URI, String.valueOf(pet.getImageURI()));
    ...
    public void updatePet(Pet pet) {
        ...
        db.update(DATABASE_TABLE, value, KEY_FIELD_ID + "=?", new String[]{String.valueOf(pet.getId())});
